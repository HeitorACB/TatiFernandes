...
export const carouselTeamItems: CarouselTeamItem[] = [
  ...
  },
  {
    ...
    description:
      ...
      descriptionEn: 'General Coordinator of RD Medicine and Professor of Cardiology at RD Step 1',
    img: 'eduardo-antonio',
  },
  {
    ...
    description:
      ...
      descriptionEn: 'Coordinator and professor of general pathology and biochemistry of the RD Step 1 course.',
  ...
  },
  {
    ...
    description:
      ...
      descriptionEn: 'Professor of Pharmacology and Reproductive System at RD Step 1.',
    img: 'lucas-chierici',
  },
  {
  ...
  },
  {
    ...
    description:
      ...
      descriptionEn: 'Clinical Research Coordinator at the Miami VA Geriatric Department (GRECC). ECFMG certified physician. Clinic by IAMSPE and Cardiologist by Instituto Dante Pazzanase.',
    img: 'nome-1',
  },
  {
    ...
    description:
      ...
      descriptionEn: 'Professor of Immunology, Biostatistics, Public Health Sciences at RD Step 1.',
  ...
  },
  {
    ...
    description:
      ...
      descriptionEn: 'Doctor graduated from Faculdade Ciencias Medicas de Minas Gerais (FCMMG) in 2021. She currently works as a Post-doctoral Research Fellow at Massachusetts General Hospital (MGH), affiliated with Harvard. ECFMG certified, applying for MATCH 2024 in Pediatrics.',
    img: 'nome-2',
  },
  {
    title: 'Nome 3',
    description:
      ...
      descriptionEn: 'Doctor graduated from the State University of Pernambuco (UPE – 2021). Research Fellow in Neurology at Mass General Hospital at Harvard Medical School. He is an applicant for the residency in Neurology for MATCH 2024.',
    img: 'nome-3',
  },
];
...
export const carouselTrainingsItems: CarouselTrainingItem[] = [
  {
    ...
    description:
      ...
      descriptionEn: 'Overcome the main barrier to becoming a doctor in the USA in 9 months with an extensive course in English and Portuguese based on simple didactics and multiple revisions, given by professors with the highest grades in Brazil.',
    img: 'rd-step-1',
    aspectRatio: 1,
  },
  {
    ...
    description:
      ...
      descriptionEn: 'Real American medical everyday English, from basic to advanced, with text studies, flash cards, exercises and 2 live weekly conversation meetings. Its your perfect preparation for internships, research, and medical residency in the US.',
    img: 'english-md',
    aspectRatio: 2.1,
  },
  {
    ...
    description:
      ...
      descriptionEn: 'Personalized and detailed mentoring from beginning to end of your validation process. VMEUA teaches the entire process, promotes round tables and networking meetings, positions you in internships, takes care of your residency application and trains you for interviews.',
  ...
  },
  {
    ...
    description:
      ...
      descriptionEn: 'RD med searches for internship opportunities in the USA according to your profile, takes care of your application documentation and writes email templates for you to send to departments.',
  ...
  },
  {
    ...
    description:
      ...
      descriptionEn: 'We seek paid and unpaid research opportunities in the US. In general, they are 1-year programs and you do not need to have your diploma validated. An opportunity to greatly strengthen your application for competitive or less competitive specialties',
  ...
  },
  {
    ...
    description:
      ...
      descriptionEn: 'We take care of everything to multiply your chances and avoid mistakes at the crucial moment of the application. The match team features mentors who are US Residency Program Directors, US Clerkship Directors and more.',
    img: 'time-do-match',
    aspectRatio: 2.08,
  },
];
